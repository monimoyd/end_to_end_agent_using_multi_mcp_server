                ...
                if config.get("transport") == "sse":
                    ...
                    tools = [
                        Tool(
                            ...
                            description="""Send a message to Telegram. Usage: send_telegram_message|message='Emails with excel sheel has been sent successfully'}""",
                            inputSchema={
                                "type": "object",
                                "properties": {
                                    "message": {
    ...
    async def call_tool(self, tool_name: str, arguments: dict) -> Any:
        ...
        if config.get("transport") == "sse":
            ...
            async with self.sse_clients[server_name] as session:
                ...
                async with session.post(url, params=arguments) as response:
