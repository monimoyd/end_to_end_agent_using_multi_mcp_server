...
- User asks: "What’s the relationship between Cricket and Sachin Tendulkar"
  ...
  ✅ Examples:
- User asks: "Create google sheet of result"
  - FUNCTION_CALL: write_data_to_sheet|input=result
  - [google sheet is created and a link with link_id is generated]
...
- If it is mentioned to send email in a step, you must perform this step without fail
- Do not ever return tool_code in your output
"""
