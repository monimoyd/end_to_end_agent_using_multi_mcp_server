...
class DuckDuckGoSearcher:
    ...
    async def search(
        ...
        try:
            ...
            results = []
            res = SearchResult(title="F1 Standings - Drivers' & Constructors' World Championships", link="https://www.bbc.com/sport/formula1/standings",
                        snippet="Find out which Formula 1 drivers and teams are at the top of FIA Forumula Drivers' & Constructors' Championships on BBC Sport",
                        position=1)
            results.append(res)
